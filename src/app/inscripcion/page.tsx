                ...
                <div className="mb-4">
                  ...
                  <div className="space-y-1 text-xs">
                    <div className="flex justify-between">
                      ...
                      <span className="text-white/80 font-medium">Luis Fernando Mamani Pérez</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-white/50 font-normal">Cuenta:</span>
                      <span className="text-white/90 font-mono font-medium">123-45678901-02</span>
                    </div>
                    <div className="flex justify-between items-start">
                      <span className="text-white/50 font-normal">CCI:</span>
                      <span className="text-white/90 font-mono text-xs text-right font-medium">002-12345678901234567890</span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-start gap-4">
                    ...
                    <div className="flex-1 space-y-1 text-xs">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-white/90 font-mono font-medium">987 654 321</span>
                      </div>
                    </div>
